...
public class DL_DIALOGUE_DATA
{
    ...
    //The data container holding all segments and infromation pertaining to a single dialogue Line
    ...
    public struct DIALOGUE_SEGMENT
    {
        ...
        // how Segment starts define
        public enum StartSignal { NONE, C, A, WA, WC } // None Clear Append WeightAppend, WeightClear
